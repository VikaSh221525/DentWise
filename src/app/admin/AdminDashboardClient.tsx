...
import AdminStats from '@/components/adminCompo/AdminStats'
import DoctorsManagement from '@/components/adminCompo/DoctorsManagement'
...
function AdminDashboardClient() {
    ...
    // calculate stats from loading data
    const stats = {
